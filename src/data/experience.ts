export const experience = [
  ...
  },
  {
    ...
    highlights: [
      'Completed 50+ hours of JavaScript and React.js training and applied concepts in production tasks.',
      'Configured and integrated 10+ Adobe Marketo Engage API-based marketing automation workflows.',
    ],
  },
  {
    company: 'Ernst & Young LLP',
    role: 'Summer Intern - ProLens Project',
    duration: 'May 2023 - Jun 2023',
    highlights: [
      'Attained 90% image detection accuracy by building computer vision models with YOLOv8.',
      'Developed FastAPI-based REST APIs to deploy machine learning models for real-time predictions.',
      'Improved inference efficiency by 20% through NMS threshold tuning and preprocessing optimizations.',
    ],
  },
];
