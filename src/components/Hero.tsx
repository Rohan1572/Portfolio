...
const rotating = ['Enterprise Banking Features', 'AI-Augmented Frontend Workflows', 'Responsive React Experiences'];
  ...
  return (
    <section id="home" className="relative overflow-hidden py-24">
      ...
      <motion.div variants={staggerContainer} initial="hidden" animate="visible" className="relative mx-auto max-w-6xl px-4 text-center">
        <motion.p variants={fadeInUp} className="mb-4 text-accent font-semibold">Frontend Developer at Deloitte with 1.5 years of experience</motion.p>
        <motion.h1 variants={fadeInUp} className="text-4xl md:text-6xl font-extrabold leading-tight">
          Building Production-Ready Frontends for Enterprise FinTech
        </motion.h1>
        <motion.p variants={fadeInUp} className="mt-5 text-slate-700 dark:text-slate-300 text-lg">
          React.js - Next.js - TypeScript - OpenAI API - Responsive UI Architecture
        </motion.p>
